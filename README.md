...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/voila-material-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=8139&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/voila-material-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `voila-material` can be installed with:

```
conda install voila-material
```

It is possible to list all of the versions of `voila-material` available on your platform with:
